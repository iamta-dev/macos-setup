...
abbr add --force ddex="docker exec -it "
abbr add --force ddrm="docker rm \$(docker ps -a -q)"
abbr add --force ddrm-img="docker images rm \$(docker images -a -q)"
abbr add --force ddrmi="docker rmi \$(docker images -q)"
abbr add --force ddrmv="\"docker volume rm VOLUME"
abbr add --force ddstop="docker stop \$(docker ps -a -q)"
